    ...
    <Container maxWidth="lg">
      ...
      <Paper sx={{ p: 3, mb: 2 }}>
        <Box display="flex" alignItems="center" justifyContent="space-between">
          <Box>
            ...
            <Typography variant="body2" color="text.secondary">
              View model metadata, version, and training information.
            </Typography>
          </Box>
        ...
        <Box mt={2}>
          ...
          {!loading && !error && info && (
            <Box mt={1}>
              <Typography><strong>Name:</strong> {info.name ?? "unknown"}</Typography>
              <Typography><strong>Version:</strong> {info.version ?? "unknown"}</Typography>
              <Typography><strong>Trained at:</strong> {info.trained_at ?? "unknown"}</Typography>
              <Typography><strong>Features:</strong> {info.feature_columns?.join(", ") ?? "unknown"}</Typography>
              <Typography><strong>Artifacts:</strong></Typography>
              <ul>
